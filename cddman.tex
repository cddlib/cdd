...
\vspace{20mm}
{\Large (cdd Version 0.53,  July 29, 1994)}

{\Large (Manual  Version  October 2, 1994)}
...
only when the input polyhedron has at least one vertex.  But  it 
...
It took about 205 hours (eight and half days!) for cdd
...
cdd.c, cddarith.c and setoper.c.  We could also compile it with some
old version of TURBO C.  Due to limited memory capacities of
these compilers, it is necessary to reduce the constants MMAX and NMAX
to, say 2001 and 51.
\end{itemize}
